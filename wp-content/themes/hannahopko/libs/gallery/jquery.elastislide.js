(function( window, $, undefined ) {
	...
	$.elastislide.prototype 	= {
		...
		_addControls		: function() {
			...
			this.$navNext	= $('<span class="es-nav-next"><i class="fa fa-chevron-right" aria-hidden="true"></i></span>');
			this.$navPrev	= $('<span class="es-nav-prev"><i class="fa fa-chevron-left" aria-hidden="true"></i></span>');
			$('<div class="es-nav"/>')
			.append( this.$navPrev )
			.append( this.$navNext )
			.appendTo( this.$el );
